...
import type { QuotationFilters } from '../api/types';
...
export function useQuotationFilters(): QuotationFilters {
  const [params] = useQueryStates({
    page: parseAsInteger.withDefault(1),
    perPage: parseAsInteger.withDefault(10),
    id: parseAsString,
    reference_no: parseAsString,
    quotation_status: parseAsString,
  ...
  return {
    ...
    ...(params.quotation_status && { quotation_status: params.quotation_status }),
