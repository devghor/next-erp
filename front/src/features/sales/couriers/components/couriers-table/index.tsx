...
export function CouriersTable() {
  ...
  return (
    <div className='flex flex-1 flex-col space-y-4'>
      ...
      >
        {hasSelection && <CouriersTableActionBar table={table} />}
      </DataTableToolbar>
      {isFetching ? (
        <DataTableSkeleton
...
export function CouriersTableSkeleton() {
  return (
