...
import type { GiftCardFilters } from '../api/types';
...
export function useGiftCardFilters(): GiftCardFilters {
  const [params] = useQueryStates({
    page: parseAsInteger.withDefault(1),
    perPage: parseAsInteger.withDefault(10),
    id: parseAsString,
    card_no: parseAsString,
  ...
  return {
    ...
    ...(params.card_no && { card_no: params.card_no }),
