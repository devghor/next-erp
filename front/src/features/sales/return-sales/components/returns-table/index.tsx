...
import { saleReturnsQueryOptions } from '../../api/queries';
import { useReturnSaleFilters } from '../../hooks/use-return-sale-filters';
import { columns } from './columns';

export function ReturnsTable() {
  const filters = useReturnSaleFilters();

  const { data, isPending, isFetching } = useQuery({
    ...saleReturnsQueryOptions(filters),
...
export function ReturnsTableSkeleton() {
  return (
