...
function emptyRow(): SaleItemFormValues {
  return { product_id: 0, qty: 1, net_unit_price: 0, discount: 0, tax_rate: 0 };
}

export function rowTotal(row: SaleItemFormValues): number {
...
export function SaleItemsEditor({ items, onChange, productOptions }: SaleItemsEditorProps) {
  const updateRow = (index: number, patch: Partial<SaleItemFormValues>) => {
