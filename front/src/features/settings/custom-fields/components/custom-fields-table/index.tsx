...
export function CustomFieldsTable() {
  ...
  if (isPending) {
    return <CustomFieldsTableSkeleton />;
  }
  ...
  return (
    <div className='flex flex-1 flex-col space-y-4'>
      ...
      >
        {hasSelection && <CustomFieldsTableActionBar table={table} />}
      </DataTableToolbar>
      {isFetching ? (
        <DataTableSkeleton
...
export function CustomFieldsTableSkeleton() {
  return (
